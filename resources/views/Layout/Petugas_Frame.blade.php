...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="navbar-nav text-white bg-dark sidebar sidebar-dark accordion" id="accordionSidebar"> 
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/petugas/dashboard')}}">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    ...
                    <a href="{{ url('/petugas/dashboard')}}" class="nav-link text-white" aria-current="page" id="dashboard">
                ...
                <li>
                    ...
                    <a href="{{ url('/petugas/data')}}" class="nav-link text-white" id="data">
            ...
            <div class="dropdown">
                ...
                <ul>
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <strong style="font-size: 12px;">{{ auth()->user()->name }}</strong>
