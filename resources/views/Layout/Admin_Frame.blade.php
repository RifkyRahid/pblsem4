        ...
        <div class="navbar-nav text-white bg-dark sidebar sidebar-dark accordion" id="accordionSidebar"> 
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    ...
                    <a href="{{ url('/admin/dashboard')}}" class="nav-link text-white" aria-current="page" id="dashboard">
                ...
                <li>
                    ...
                    <a href="{{ url('/admin/data')}}" class="nav-link text-white" id="data">
                ...
                <li>
                    ...
                    <a href="{{ url('/admin/data/konfirmasi')}}" class="nav-link text-white" id="data">
