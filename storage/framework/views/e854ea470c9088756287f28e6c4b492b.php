...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="navbar-nav text-white bg-dark sidebar sidebar-dark accordion" id="accordionSidebar"> 
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(url('/petugas/dashboard')); ?>">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    ...
                    <a href="<?php echo e(url('/petugas/dashboard')); ?>" class="nav-link text-white" aria-current="page" id="dashboard">
                ...
                <li>
                    ...
                    <a href="<?php echo e(url('/petugas/data')); ?>" class="nav-link text-white" id="data">
...
</html><?php /**PATH D:\Xampp\htdocs\PBL4\resources\views/Layout/Petugas_Frame.blade.php ENDPATH**/ ?>