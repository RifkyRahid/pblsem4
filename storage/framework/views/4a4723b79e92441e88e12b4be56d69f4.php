...
<?php $__env->startSection('Frame'); ?>
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
            ...
            <span class="fs-3">Data  Barang Admin</span>

        </a>

    </header>

    <a href="<?php echo e(url('/admin/data/create')); ?>" class="btn btn-primary">Tambah Data</a>
...
<?php echo $__env->make('Layout/Admin_Frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\PBL4\resources\views/Section_Admin/Data_Barang_Admin.blade.php ENDPATH**/ ?>